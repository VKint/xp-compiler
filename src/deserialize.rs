...
// Common interface for deserializing the scripts
#[derive(Deserialize)]
...
impl XpCallJson {
    ...
    // Converts Move & converts it to common interface
    ...
    // Compiles the common interface to a target language smart contract
    ...
    // Detects the target language & calls the decode_call
